...
{
    extension(MqttServerOptions options)
    {
        public ServerOptions Map() => new()
        {
    ...
    extension(IReadOnlyDictionary<string, MqttEndpoint> endpoints)
    {
        public IReadOnlyDictionary<string, Func<IAsyncEnumerable<TransportConnection>>> Map(
            Dictionary<string, CertificateOptions> certificates,
