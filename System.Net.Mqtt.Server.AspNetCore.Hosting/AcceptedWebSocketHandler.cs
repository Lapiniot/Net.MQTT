...
{
    public class AcceptedWebSocketHandler : IAsyncEnumerable<INetworkConnection>, IAcceptedWebSocketHandler
    {
        private readonly ChannelReader<WebSocketConnection> reader;
        private readonly ChannelWriter<WebSocketConnection> writer;

        public AcceptedWebSocketHandler(IOptions<WebSocketListenerOptions> options)
        {
