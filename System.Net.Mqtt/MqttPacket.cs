...
{
    /// <summary>
    /// Writes binary representation of the packet to the <seealso cref="IBufferWriter{byte}" /> writer.
    /// </summary>
    /// <param name="writer">Buffer writer instance.</param>
    /// <param name="buffer">Underlaying buffer provided by the <paramref name="writer"> for this write operation.</paramref>
