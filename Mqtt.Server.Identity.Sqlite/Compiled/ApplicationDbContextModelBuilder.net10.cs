...
namespace Mqtt.Server.Identity.Sqlite.Compiled
{
    public partial class ApplicationDbContextModel
    {
        private ApplicationDbContextModel()
            : base(skipDetectChanges: false, modelId: new Guid("5b56727f-3592-4add-8ccf-cb6c63a5a2b5"), entityTypeCount: 9)
        {
        }
        ...
        private IRelationalModel CreateRelationalModel()
        {
            ...
            var credentialIdColumnBase = new ColumnBase<ColumnMappingBase>("CredentialId", "BLOB", microsoftAspNetCoreIdentityIdentityUserPasskeystringTableBase);
            microsoftAspNetCoreIdentityIdentityUserPasskeystringTableBase.Columns.Add("CredentialId", credentialIdColumnBase);
            var dataColumnBase = new JsonColumnBase("Data", "TEXT", microsoftAspNetCoreIdentityIdentityUserPasskeystringTableBase);
            microsoftAspNetCoreIdentityIdentityUserPasskeystringTableBase.Columns.Add("Data", dataColumnBase);
            var userIdColumnBase = new ColumnBase<ColumnMappingBase>("UserId", "TEXT", microsoftAspNetCoreIdentityIdentityUserPasskeystringTableBase);
            ...
            var credentialIdColumn = new Column("CredentialId", "BLOB", aspNetUserPasskeysTable);
            ...
            var dataColumn = new JsonColumn("Data", "TEXT", aspNetUserPasskeysTable);
            ...
            var userIdColumn = new Column("UserId", "TEXT", aspNetUserPasskeysTable);
            ...
            var accessFailedCountColumnBase = new ColumnBase<ColumnMappingBase>("AccessFailedCount", "INTEGER", mqttServerIdentityDataApplicationUserTableBase);
            mqttServerIdentityDataApplicationUserTableBase.Columns.Add("AccessFailedCount", accessFailedCountColumnBase);
            var concurrencyStampColumnBase0 = new ColumnBase<ColumnMappingBase>("ConcurrencyStamp", "TEXT", mqttServerIdentityDataApplicationUserTableBase)
            {
                IsNullable = true
            };
            mqttServerIdentityDataApplicationUserTableBase.Columns.Add("ConcurrencyStamp", concurrencyStampColumnBase0);
            var emailColumnBase = new ColumnBase<ColumnMappingBase>("Email", "TEXT", mqttServerIdentityDataApplicationUserTableBase)
            {
                IsNullable = true
            };
            mqttServerIdentityDataApplicationUserTableBase.Columns.Add("Email", emailColumnBase);
            var emailConfirmedColumnBase = new ColumnBase<ColumnMappingBase>("EmailConfirmed", "INTEGER", mqttServerIdentityDataApplicationUserTableBase);
            ...
            var lockoutEnabledColumnBase = new ColumnBase<ColumnMappingBase>("LockoutEnabled", "INTEGER", mqttServerIdentityDataApplicationUserTableBase);
            mqttServerIdentityDataApplicationUserTableBase.Columns.Add("LockoutEnabled", lockoutEnabledColumnBase);
            var lockoutEndColumnBase = new ColumnBase<ColumnMappingBase>("LockoutEnd", "TEXT", mqttServerIdentityDataApplicationUserTableBase)
            {
                IsNullable = true
            };
            mqttServerIdentityDataApplicationUserTableBase.Columns.Add("LockoutEnd", lockoutEndColumnBase);
            var normalizedEmailColumnBase = new ColumnBase<ColumnMappingBase>("NormalizedEmail", "TEXT", mqttServerIdentityDataApplicationUserTableBase)
            {
                IsNullable = true
            };
            mqttServerIdentityDataApplicationUserTableBase.Columns.Add("NormalizedEmail", normalizedEmailColumnBase);
            var normalizedUserNameColumnBase = new ColumnBase<ColumnMappingBase>("NormalizedUserName", "TEXT", mqttServerIdentityDataApplicationUserTableBase)
            {
                IsNullable = true
            };
            mqttServerIdentityDataApplicationUserTableBase.Columns.Add("NormalizedUserName", normalizedUserNameColumnBase);
            var passwordHashColumnBase = new ColumnBase<ColumnMappingBase>("PasswordHash", "TEXT", mqttServerIdentityDataApplicationUserTableBase)
            {
                IsNullable = true
            };
            mqttServerIdentityDataApplicationUserTableBase.Columns.Add("PasswordHash", passwordHashColumnBase);
            var phoneNumberColumnBase = new ColumnBase<ColumnMappingBase>("PhoneNumber", "TEXT", mqttServerIdentityDataApplicationUserTableBase)
            {
                IsNullable = true
            };
            mqttServerIdentityDataApplicationUserTableBase.Columns.Add("PhoneNumber", phoneNumberColumnBase);
            var phoneNumberConfirmedColumnBase = new ColumnBase<ColumnMappingBase>("PhoneNumberConfirmed", "INTEGER", mqttServerIdentityDataApplicationUserTableBase);
            mqttServerIdentityDataApplicationUserTableBase.Columns.Add("PhoneNumberConfirmed", phoneNumberConfirmedColumnBase);
            var securityStampColumnBase = new ColumnBase<ColumnMappingBase>("SecurityStamp", "TEXT", mqttServerIdentityDataApplicationUserTableBase)
            {
                IsNullable = true
            };
            mqttServerIdentityDataApplicationUserTableBase.Columns.Add("SecurityStamp", securityStampColumnBase);
            var twoFactorEnabledColumnBase = new ColumnBase<ColumnMappingBase>("TwoFactorEnabled", "INTEGER", mqttServerIdentityDataApplicationUserTableBase);
            mqttServerIdentityDataApplicationUserTableBase.Columns.Add("TwoFactorEnabled", twoFactorEnabledColumnBase);
            var userNameColumnBase = new ColumnBase<ColumnMappingBase>("UserName", "TEXT", mqttServerIdentityDataApplicationUserTableBase)
            {
                IsNullable = true
            };
