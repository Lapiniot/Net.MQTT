...
namespace Mqtt.Server.Identity.Sqlite.Compiled
{
    ...
    public partial class IdentityPasskeyDataEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            identityUserPasskeyCredentialId.TypeMapping = SqliteByteArrayTypeMapping.Default.Clone(
            ...
            attestationObject.TypeMapping = SqliteByteArrayTypeMapping.Default.Clone(
                comparer: new ValueComparer<byte[]>(
                    bool (byte[] v1, byte[] v2) => StructuralComparisons.StructuralEqualityComparer.Equals(((object)(v1)), ((object)(v2))),
                    int (byte[] v) => ((object)v).GetHashCode(),
                    byte[] (byte[] v) => v),
            ...
            clientDataJson.SetPropertyIndexes(
                ...
                relationshipIndex: -1,
                storeGenerationIndex: -1);
            clientDataJson.TypeMapping = SqliteByteArrayTypeMapping.Default.Clone(
                comparer: new ValueComparer<byte[]>(
                    bool (byte[] v1, byte[] v2) => StructuralComparisons.StructuralEqualityComparer.Equals(((object)(v1)), ((object)(v2))),
                    int (byte[] v) => ((object)v).GetHashCode(),
                    byte[] (byte[] v) => v),
            ...
            isBackedUp.SetPropertyIndexes(
                ...
                relationshipIndex: -1,
                storeGenerationIndex: -1);
            isBackedUp.TypeMapping = BoolTypeMapping.Default.Clone(
            ...
            isBackupEligible.SetPropertyIndexes(
                ...
                relationshipIndex: -1,
                storeGenerationIndex: -1);
            isBackupEligible.TypeMapping = BoolTypeMapping.Default.Clone(
                comparer: new ValueComparer<bool>(
                    bool (bool v1, bool v2) => v1 == v2,
                    int (bool v) => ((object)v).GetHashCode(),
                    bool (bool v) => v),
            ...
            isUserVerified.SetPropertyIndexes(
                ...
                relationshipIndex: -1,
                storeGenerationIndex: -1);
            isUserVerified.TypeMapping = BoolTypeMapping.Default.Clone(
                comparer: new ValueComparer<bool>(
                    bool (bool v1, bool v2) => v1 == v2,
                    int (bool v) => ((object)v).GetHashCode(),
                    bool (bool v) => v),
            ...
            publicKey.SetPropertyIndexes(
                ...
                relationshipIndex: -1,
                storeGenerationIndex: -1);
            publicKey.TypeMapping = SqliteByteArrayTypeMapping.Default.Clone(
                comparer: new ValueComparer<byte[]>(
                    bool (byte[] v1, byte[] v2) => StructuralComparisons.StructuralEqualityComparer.Equals(((object)(v1)), ((object)(v2))),
                    int (byte[] v) => ((object)v).GetHashCode(),
                    byte[] (byte[] v) => v),
            ...
            signCount.SetPropertyIndexes(
                ...
                relationshipIndex: -1,
                storeGenerationIndex: -1);
            signCount.TypeMapping = UIntTypeMapping.Default.Clone(
            ...
            transports.SetPropertyIndexes(
                ...
                relationshipIndex: -1,
                storeGenerationIndex: -1);
            transports.TypeMapping = SqliteStringTypeMapping.Default.Clone(
