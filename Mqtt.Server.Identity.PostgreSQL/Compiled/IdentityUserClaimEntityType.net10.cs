...
namespace Mqtt.Server.Identity.PostgreSQL.Compiled
{
    ...
    public partial class IdentityUserClaimEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            key.AddAnnotation("Relational:Name", "pk_identity_user_claim_string");

            var index = runtimeEntityType.AddIndex(
                new[] { userId });
            index.AddAnnotation("Relational:Name", "ix_identity_user_claim_string_user_id");
        ...
        public static RuntimeForeignKey CreateForeignKey1(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
        {
            ...
            runtimeForeignKey.AddAnnotation("Relational:Name", "fk_identity_user_claim_string_asp_net_users_application_user_id");
        ...
        public static void CreateAnnotations(RuntimeEntityType runtimeEntityType)
        {
            ...
            runtimeEntityType.AddAnnotation("Relational:TableName", "asp_net_user_claims");
