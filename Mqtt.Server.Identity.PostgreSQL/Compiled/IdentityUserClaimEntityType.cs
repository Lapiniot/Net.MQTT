    ...
    public partial class IdentityUserClaimEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            id.SetMaterializationSetter(
                (IdentityUserClaim<string> entity, int value) => IdentityUserClaimUnsafeAccessors<string>.Id(entity) = value);
            id.SetAccessors(
                int (InternalEntityEntry entry) => (entry.FlaggedAsStoreGenerated(0) ? entry.ReadStoreGeneratedValue<int>(0) : (entry.FlaggedAsTemporary(0) && IdentityUserClaimUnsafeAccessors<string>.Id(((IdentityUserClaim<string>)(entry.Entity))) == 0 ? entry.ReadTemporaryValue<int>(0) : IdentityUserClaimUnsafeAccessors<string>.Id(((IdentityUserClaim<string>)(entry.Entity))))),
            ...
            userId.SetMaterializationSetter(
                (IdentityUserClaim<string> entity, string value) => IdentityUserClaimUnsafeAccessors<string>.UserId(entity) = value);
            userId.SetAccessors(
                string (InternalEntityEntry entry) => (entry.FlaggedAsStoreGenerated(3) ? entry.ReadStoreGeneratedValue<string>(1) : (entry.FlaggedAsTemporary(3) && IdentityUserClaimUnsafeAccessors<string>.UserId(((IdentityUserClaim<string>)(entry.Entity))) == null ? entry.ReadTemporaryValue<string>(1) : IdentityUserClaimUnsafeAccessors<string>.UserId(((IdentityUserClaim<string>)(entry.Entity))))),
