...
namespace Mqtt.Server.Identity.PostgreSQL.Compiled
{
    public partial class ApplicationDbContextModel
    {
        private ApplicationDbContextModel()
            : base(skipDetectChanges: false, modelId: new Guid("9f09e4d7-6767-4574-a06c-e6be256b4eda"), entityTypeCount: 9)
        {
        }
        ...
        private IRelationalModel CreateRelationalModel()
        {
            ...
            var credential_idColumnBase = new ColumnBase<ColumnMappingBase>("credential_id", "bytea", microsoftAspNetCoreIdentityIdentityUserPasskeystringTableBase);
            microsoftAspNetCoreIdentityIdentityUserPasskeystringTableBase.Columns.Add("credential_id", credential_idColumnBase);
            var dataColumnBase = new JsonColumnBase("data", "jsonb", microsoftAspNetCoreIdentityIdentityUserPasskeystringTableBase);
            microsoftAspNetCoreIdentityIdentityUserPasskeystringTableBase.Columns.Add("data", dataColumnBase);
            var user_idColumnBase = new ColumnBase<ColumnMappingBase>("user_id", "text", microsoftAspNetCoreIdentityIdentityUserPasskeystringTableBase);
            microsoftAspNetCoreIdentityIdentityUserPasskeystringTableBase.Columns.Add("user_id", user_idColumnBase);
            ...
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)credential_idColumnBase, identityUserPasskey.FindProperty("CredentialId")!, microsoftAspNetCoreIdentityIdentityUserPasskeystringMappingBase0);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)user_idColumnBase, identityUserPasskey.FindProperty("UserId")!, microsoftAspNetCoreIdentityIdentityUserPasskeystringMappingBase0);

            var tableMappings = new List<TableMapping>();
            identityPasskeyData.SetRuntimeAnnotation("Relational:TableMappings", tableMappings);
            var asp_net_user_passkeysTable = new Table("asp_net_user_passkeys", null, relationalModel);
            var credential_idColumn = new Column("credential_id", "bytea", asp_net_user_passkeysTable);
            asp_net_user_passkeysTable.Columns.Add("credential_id", credential_idColumn);
            credential_idColumn.Accessors = ColumnAccessorsFactory.CreateGeneric<byte[]>(credential_idColumn);
            var dataColumn = new JsonColumn("data", "jsonb", asp_net_user_passkeysTable);
            asp_net_user_passkeysTable.Columns.Add("data", dataColumn);
            dataColumn.Accessors = ColumnAccessorsFactory.CreateGeneric<JsonTypePlaceholder>(dataColumn);
            var user_idColumn = new Column("user_id", "text", asp_net_user_passkeysTable);
            asp_net_user_passkeysTable.Columns.Add("user_id", user_idColumn);
            user_idColumn.Accessors = ColumnAccessorsFactory.CreateGeneric<string>(user_idColumn);
            relationalModel.Tables.Add(("asp_net_user_passkeys", null), asp_net_user_passkeysTable);
            var asp_net_user_passkeysTableMapping = new TableMapping(identityPasskeyData, asp_net_user_passkeysTable, null)
            {
                IsSharedTablePrincipal = false,
            };
            asp_net_user_passkeysTable.AddTypeMapping(asp_net_user_passkeysTableMapping, null);
            tableMappings.Add(asp_net_user_passkeysTableMapping);
            asp_net_user_passkeysTable.AddRowInternalForeignKey(identityPasskeyData, RelationalModel.GetForeignKey(this,
            ...
            var asp_net_user_passkeysTableMapping0 = new TableMapping(identityUserPasskey, asp_net_user_passkeysTable, null)
            {
                IsSharedTablePrincipal = true,
            };
            asp_net_user_passkeysTable.AddTypeMapping(asp_net_user_passkeysTableMapping0, false);
            tableMappings4.Add(asp_net_user_passkeysTableMapping0);
            RelationalModel.CreateColumnMapping(credential_idColumn, identityUserPasskey.FindProperty("CredentialId")!, asp_net_user_passkeysTableMapping0);
            RelationalModel.CreateColumnMapping(user_idColumn, identityUserPasskey.FindProperty("UserId")!, asp_net_user_passkeysTableMapping0);
            var pk_identity_user_passkey_string = new UniqueConstraint("pk_identity_user_passkey_string", asp_net_user_passkeysTable, new[] { credential_idColumn });
            asp_net_user_passkeysTable.PrimaryKey = pk_identity_user_passkey_string;
            pk_identity_user_passkey_string.SetRowKeyValueFactory(new SimpleRowKeyValueFactory<byte[]>(pk_identity_user_passkey_string));
            var pk_identity_user_passkey_stringKey = RelationalModel.GetKey(this,
                "Microsoft.AspNetCore.Identity.IdentityUserPasskey<string>",
                new[] { "CredentialId" });
            pk_identity_user_passkey_string.MappedKeys.Add(pk_identity_user_passkey_stringKey);
            RelationalModel.GetOrCreateUniqueConstraints(pk_identity_user_passkey_stringKey).Add(pk_identity_user_passkey_string);
            asp_net_user_passkeysTable.UniqueConstraints.Add("pk_identity_user_passkey_string", pk_identity_user_passkey_string);
            var ix_identity_user_passkey_string_user_id = new TableIndex(
            "ix_identity_user_passkey_string_user_id", asp_net_user_passkeysTable, new[] { user_idColumn }, false);
            ix_identity_user_passkey_string_user_id.SetRowIndexValueFactory(new SimpleRowIndexValueFactory<string>(ix_identity_user_passkey_string_user_id));
            var ix_identity_user_passkey_string_user_idIx = RelationalModel.GetIndex(this,
                "Microsoft.AspNetCore.Identity.IdentityUserPasskey<string>",
                new[] { "UserId" });
            ix_identity_user_passkey_string_user_id.MappedIndexes.Add(ix_identity_user_passkey_string_user_idIx);
            RelationalModel.GetOrCreateTableIndexes(ix_identity_user_passkey_string_user_idIx).Add(ix_identity_user_passkey_string_user_id);
            asp_net_user_passkeysTable.Indexes.Add("ix_identity_user_passkey_string_user_id", ix_identity_user_passkey_string_user_id);
            ...
            tableMappings0.Add(asp_net_rolesTableMapping);
            ...
            tableMappings1.Add(asp_net_role_claimsTableMapping);
            ...
            var user_idColumnBase0 = new ColumnBase<ColumnMappingBase>("user_id", "text", microsoftAspNetCoreIdentityIdentityUserClaimstringTableBase);
            microsoftAspNetCoreIdentityIdentityUserClaimstringTableBase.Columns.Add("user_id", user_idColumnBase0);
            ...
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)user_idColumnBase0, identityUserClaim.FindProperty("UserId")!, microsoftAspNetCoreIdentityIdentityUserClaimstringMappingBase);
            ...
            var user_idColumn0 = new Column("user_id", "text", asp_net_user_claimsTable);
            asp_net_user_claimsTable.Columns.Add("user_id", user_idColumn0);
            ...
            tableMappings2.Add(asp_net_user_claimsTableMapping);
            ...
            RelationalModel.CreateColumnMapping(user_idColumn0, identityUserClaim.FindProperty("UserId")!, asp_net_user_claimsTableMapping);
            ...
            "ix_identity_user_claim_string_user_id", asp_net_user_claimsTable, new[] { user_idColumn0 }, false);
            ...
            var login_providerColumnBase = new ColumnBase<ColumnMappingBase>("login_provider", "character varying(128)", microsoftAspNetCoreIdentityIdentityUserLoginstringTableBase);
            ...
            var provider_keyColumnBase = new ColumnBase<ColumnMappingBase>("provider_key", "character varying(128)", microsoftAspNetCoreIdentityIdentityUserLoginstringTableBase);
            microsoftAspNetCoreIdentityIdentityUserLoginstringTableBase.Columns.Add("provider_key", provider_keyColumnBase);
            var user_idColumnBase1 = new ColumnBase<ColumnMappingBase>("user_id", "text", microsoftAspNetCoreIdentityIdentityUserLoginstringTableBase);
            microsoftAspNetCoreIdentityIdentityUserLoginstringTableBase.Columns.Add("user_id", user_idColumnBase1);
            ...
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)user_idColumnBase1, identityUserLogin.FindProperty("UserId")!, microsoftAspNetCoreIdentityIdentityUserLoginstringMappingBase);
            ...
            var login_providerColumn = new Column("login_provider", "character varying(128)", asp_net_user_loginsTable);
            ...
            var provider_keyColumn = new Column("provider_key", "character varying(128)", asp_net_user_loginsTable);
            ...
            var user_idColumn1 = new Column("user_id", "text", asp_net_user_loginsTable);
            asp_net_user_loginsTable.Columns.Add("user_id", user_idColumn1);
            ...
            tableMappings3.Add(asp_net_user_loginsTableMapping);
            ...
            RelationalModel.CreateColumnMapping(user_idColumn1, identityUserLogin.FindProperty("UserId")!, asp_net_user_loginsTableMapping);
            ...
            "ix_identity_user_login_string_user_id", asp_net_user_loginsTable, new[] { user_idColumn1 }, false);
            ...
            var user_idColumnBase2 = new ColumnBase<ColumnMappingBase>("user_id", "text", microsoftAspNetCoreIdentityIdentityUserRolestringTableBase);
            microsoftAspNetCoreIdentityIdentityUserRolestringTableBase.Columns.Add("user_id", user_idColumnBase2);
            ...
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)user_idColumnBase2, identityUserRole.FindProperty("UserId")!, microsoftAspNetCoreIdentityIdentityUserRolestringMappingBase);
            ...
            var user_idColumn2 = new Column("user_id", "text", asp_net_user_rolesTable);
            asp_net_user_rolesTable.Columns.Add("user_id", user_idColumn2);
            ...
            tableMappings5.Add(asp_net_user_rolesTableMapping);
            RelationalModel.CreateColumnMapping(role_idColumn0, identityUserRole.FindProperty("RoleId")!, asp_net_user_rolesTableMapping);
            RelationalModel.CreateColumnMapping(user_idColumn2, identityUserRole.FindProperty("UserId")!, asp_net_user_rolesTableMapping);
            var pk_identity_user_role_string = new UniqueConstraint("pk_identity_user_role_string", asp_net_user_rolesTable, new[] { user_idColumn2, role_idColumn0 });
            ...
            var login_providerColumnBase0 = new ColumnBase<ColumnMappingBase>("login_provider", "character varying(128)", microsoftAspNetCoreIdentityIdentityUserTokenstringTableBase);
            microsoftAspNetCoreIdentityIdentityUserTokenstringTableBase.Columns.Add("login_provider", login_providerColumnBase0);
            var nameColumnBase0 = new ColumnBase<ColumnMappingBase>("name", "character varying(128)", microsoftAspNetCoreIdentityIdentityUserTokenstringTableBase);
            microsoftAspNetCoreIdentityIdentityUserTokenstringTableBase.Columns.Add("name", nameColumnBase0);
            var user_idColumnBase3 = new ColumnBase<ColumnMappingBase>("user_id", "text", microsoftAspNetCoreIdentityIdentityUserTokenstringTableBase);
            microsoftAspNetCoreIdentityIdentityUserTokenstringTableBase.Columns.Add("user_id", user_idColumnBase3);
            ...
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)user_idColumnBase3, identityUserToken.FindProperty("UserId")!, microsoftAspNetCoreIdentityIdentityUserTokenstringMappingBase);
            ...
            var user_idColumn3 = new Column("user_id", "text", asp_net_user_tokensTable);
            asp_net_user_tokensTable.Columns.Add("user_id", user_idColumn3);
            user_idColumn3.Accessors = ColumnAccessorsFactory.CreateGeneric<string>(user_idColumn3);
            var login_providerColumn0 = new Column("login_provider", "character varying(128)", asp_net_user_tokensTable);
            ...
            var nameColumn0 = new Column("name", "character varying(128)", asp_net_user_tokensTable);
            ...
            tableMappings6.Add(asp_net_user_tokensTableMapping);
            ...
            RelationalModel.CreateColumnMapping(user_idColumn3, identityUserToken.FindProperty("UserId")!, asp_net_user_tokensTableMapping);
            RelationalModel.CreateColumnMapping(valueColumn, identityUserToken.FindProperty("Value")!, asp_net_user_tokensTableMapping);
            var pk_identity_user_token_string = new UniqueConstraint("pk_identity_user_token_string", asp_net_user_tokensTable, new[] { user_idColumn3, login_providerColumn0, nameColumn0 });
            ...
            var phone_numberColumnBase = new ColumnBase<ColumnMappingBase>("phone_number", "character varying(256)", mqttServerIdentityDataApplicationUserTableBase)
            {
                IsNullable = true
            };
            ...
            var phone_numberColumn = new Column("phone_number", "character varying(256)", asp_net_usersTable)
            {
                IsNullable = true
            };
            ...
            tableMappings7.Add(asp_net_usersTableMapping);
            ...
            var fk_identity_user_passkey_string_asp_net_users_application_user_id = new ForeignKeyConstraint(
                "fk_identity_user_passkey_string_asp_net_users_application_user_id", asp_net_user_passkeysTable, asp_net_usersTable,
                new[] { user_idColumn },
                asp_net_usersTable.FindUniqueConstraint("pk_application_user")!, ReferentialAction.Cascade);
            fk_identity_user_passkey_string_asp_net_users_application_user_id.SetRowForeignKeyValueFactory(RowForeignKeyValueFactoryFactory.CreateSimpleNullableFactory<string, string>(fk_identity_user_passkey_string_asp_net_users_application_user_id));
            var fk_identity_user_passkey_string_asp_net_users_application_user_idFk = RelationalModel.GetForeignKey(this,
                "Microsoft.AspNetCore.Identity.IdentityUserPasskey<string>",
                new[] { "UserId" },
                "Mqtt.Server.Identity.Data.ApplicationUser",
                new[] { "Id" });
            fk_identity_user_passkey_string_asp_net_users_application_user_id.MappedForeignKeys.Add(fk_identity_user_passkey_string_asp_net_users_application_user_idFk);
            RelationalModel.GetOrCreateForeignKeyConstraints(fk_identity_user_passkey_string_asp_net_users_application_user_idFk).Add(fk_identity_user_passkey_string_asp_net_users_application_user_id);
            asp_net_user_passkeysTable.ForeignKeyConstraints.Add(fk_identity_user_passkey_string_asp_net_users_application_user_id);
            asp_net_usersTable.ReferencingForeignKeyConstraints.Add(fk_identity_user_passkey_string_asp_net_users_application_user_id);
