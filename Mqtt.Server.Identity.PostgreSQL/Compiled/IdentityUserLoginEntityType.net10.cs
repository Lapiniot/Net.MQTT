...
namespace Mqtt.Server.Identity.PostgreSQL.Compiled
{
    ...
    public partial class IdentityUserLoginEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            loginProvider.TypeMapping = NpgsqlStringTypeMapping.Default.Clone(
                ...
                mappingInfo: new RelationalTypeMappingInfo(
                    ...
                    size: 128));
            loginProvider.TypeMapping = ((NpgsqlStringTypeMapping)loginProvider.TypeMapping).Clone(npgsqlDbType: NpgsqlTypes.NpgsqlDbType.Varchar);
            ...
            providerKey.SetPropertyIndexes(
                ...
                relationshipIndex: 1,
                storeGenerationIndex: -1);
            providerKey.TypeMapping = NpgsqlStringTypeMapping.Default.Clone(
                comparer: new ValueComparer<string>(
                    bool (string v1, string v2) => v1 == v2,
                    int (string v) => ((object)v).GetHashCode(),
                    string (string v) => v),
                ...
                mappingInfo: new RelationalTypeMappingInfo(
                    storeTypeName: "character varying(128)",
                    size: 128));
            providerKey.TypeMapping = ((NpgsqlStringTypeMapping)providerKey.TypeMapping).Clone(npgsqlDbType: NpgsqlTypes.NpgsqlDbType.Varchar);
