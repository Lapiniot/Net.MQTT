...
namespace System.Net.Mqtt.Tests.ConnectPacket
{
    ...
    public class V4TryParseShould
    {
        ...
        {
            var actual = Packets.ConnectPacket.TryRead(sample, out var packet, out _);
        ...
        {
            var actual = Packets.ConnectPacket.TryRead(fragmentedSample, out var packet, out _);
        ...
        {
            var actual = Packets.ConnectPacket.TryRead(noWillMessageSample, out var packet, out _);
        ...
        {
            var actual = Packets.ConnectPacket.TryRead(noClientIdSample, out var packet, out _);
        ...
        {
            var actual = Packets.ConnectPacket.TryRead(noUserNameSample, out var packet, out _);
        ...
        {
            var actual = Packets.ConnectPacket.TryRead(noPasswordSample, out var packet, out _);
        ...
        {
            var actual = Packets.ConnectPacket.TryRead(invalidTypeSample, out var packet, out _);
        ...
        {
            var actual = Packets.ConnectPacket.TryRead(invalidTypeFragmentedSample, out var packet, out _);
        ...
        {
            var actual = Packets.ConnectPacket.TryRead(invalidSizeSample, out var packet, out _);
        ...
        {
            var actual = Packets.ConnectPacket.TryRead(invalidSizeFragmentedSample, out var packet, out _);
