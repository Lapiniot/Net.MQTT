...
namespace System.Net.Mqtt.Extensions
{
    ...
    public class SpanExtensions_EncodeMqttLengthBytes_Should
    {
        ...
        public void Throw_IndexOutOfRangeException_IfInsufficientBufferSizeProvided()
        {
            ...
            SpanExtensions.EncodeMqttLengthBytes(2097151, actualBytes);
        }
        ...
        public void Encode_1_Byte_0_GivenValueOf0()
        {
            ...
            var actualCount = SpanExtensions.EncodeMqttLengthBytes(0, actualBytes);
        ...
        {
            Span<byte> actualBytes = new byte[4];
            var actualCount = SpanExtensions.EncodeMqttLengthBytes(127, actualBytes);
            Assert.AreEqual(1, actualCount);
        ...
        {
            Span<byte> actualBytes = new byte[4];
            var actualCount = SpanExtensions.EncodeMqttLengthBytes(128, actualBytes);
        ...
        {
            Span<byte> actualBytes = new byte[4];
            var actualCount = SpanExtensions.EncodeMqttLengthBytes(16383, actualBytes);
            Assert.AreEqual(2, actualCount);
        ...
        {
            Span<byte> actualBytes = new byte[4];
            var actualCount = SpanExtensions.EncodeMqttLengthBytes(16384, actualBytes);
        ...
        {
            Span<byte> actualBytes = new byte[4];
            var actualCount = SpanExtensions.EncodeMqttLengthBytes(2097151, actualBytes);
            Assert.AreEqual(3, actualCount);
            Assert.AreEqual(255, actualBytes[0]);
        ...
        {
            Span<byte> actualBytes = new byte[4];
            var actualCount = SpanExtensions.EncodeMqttLengthBytes(2097152, actualBytes);
        ...
        {
            Span<byte> actualBytes = new byte[4];
            var actualCount = SpanExtensions.EncodeMqttLengthBytes(268435455, actualBytes);
            Assert.AreEqual(4, actualCount);
            Assert.AreEqual(255, actualBytes[0]);
            Assert.AreEqual(255, actualBytes[1]);
