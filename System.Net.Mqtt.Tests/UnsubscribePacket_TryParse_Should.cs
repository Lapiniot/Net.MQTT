    ...
    public class UnsubscribePacket_TryParse_Should
    {
        ...
        public UnsubscribePacket_TryParse_Should()
        {
            ...
            var segment2 = segment1
                ...
                .Append(new byte[] { 0x2f, 0x66, 0x00, 0x05, 0x67, 0x2f, 0x68, 0x2f });

            var segment3 = segment2.Append(new byte[] { 0x69 });

            fragmentedSequence = new ReadOnlySequence<byte>(segment1, 0, segment2, 4);
            largerFragmentedSequence = new ReadOnlySequence<byte>(segment1, 0, segment3, 1);
        }
