...
public class TryReadPayloadShould
{
    ...
    public void ReturnTrue_PacketNotNull_GivenValidSample()
    {
        var sequence = new ReadOnlySequence<byte>(new byte[] {
            0xb0, 0x33, 0x00, 0x02, 0x2d, 0x1f, 0x00, 0x0a, 0x61, 0x6e, 0x79,
            0x20, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x26, 0x00, 0x05, 0x70,
            0x72, 0x6f, 0x70, 0x31, 0x00, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65,
            0x31, 0x26, 0x00, 0x05, 0x70, 0x72, 0x6f, 0x70, 0x32, 0x00, 0x06,
            0x76, 0x61, 0x6c, 0x75, 0x65, 0x32, 0x01, 0x00, 0x02
        });
    ...
    public void ParseOnlyRelevantData_GivenLargerSizeValidSample()
    {
        var sequence = new ReadOnlySequence<byte>(new byte[] {
            ...
            0x72, 0x6f, 0x70, 0x31, 0x00, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65,
            0x31, 0x26, 0x00, 0x05, 0x70, 0x72, 0x6f, 0x70, 0x32, 0x00, 0x06,
            0x76, 0x61, 0x6c, 0x75, 0x65, 0x32, 0x01, 0x00, 0x02, 0x00, 0x00,
