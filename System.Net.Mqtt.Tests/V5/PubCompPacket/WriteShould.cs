...
public class WriteShould
{
    ...
    public void WriteHeader_PacketId_NoReasonCode_GivenDefaultReasonCode()
    {
        ...
        var written = new Packets.V5.PubCompPacket(16).Write(writer, out var buffer);
    ...
    public void WriteHeader_PacketId_ReasonCode_GivenDefaultReasonCode()
    {
        ...
        var written = new Packets.V5.PubCompPacket(16, ReasonCode.UnspecifiedError).Write(writer, out var buffer);
