...
namespace System.Net.Mqtt.Tests.V5.PubAckPacket;
...
public class WriteShould
{
    ...
    public void WriteHeader_PacketId_NoReasonCode_GivenDefaultReasonCode()
    {
        ...
        var written = new Packets.V5.PubAckPacket(16).Write(writer, int.MaxValue, out var buffer);
    ...
    public void WriteHeader_PacketId_ReasonCode_GivenDefaultReasonCode()
    {
        ...
        var written = new Packets.V5.PubAckPacket(16, ReasonCode.UnspecifiedError).Write(writer, int.MaxValue, out var buffer);
