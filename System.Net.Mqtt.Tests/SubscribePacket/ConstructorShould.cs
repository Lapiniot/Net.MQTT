...
public class ConstructorShould
{
    ...
    {
        var _ = new Packets.SubscribePacket(0, new (ReadOnlyMemory<byte>, byte)[] { ((byte[])"topic1", 0) });
    }
    ...
    {
        var _ = new Packets.SubscribePacket(1, Array.Empty<(ReadOnlyMemory<byte>, byte)>());
    }
}