...
public class TryParseShould
{
    ...
    private readonly ByteSequence sampleRetainFlag = new(new byte[]
    {
        0x31, 0x07, 0x00, 0x05,
        0x61, 0x2f, 0x62, 0x2f,
        0x63
    ...
    {
        var segment1 = new Segment<byte>(new byte[] { 0x3b, 0x0e, 0x00, 0x05 });
    ...
    public void DecodeTopicAbcGivenSample()
    {
        ...
        Assert.IsTrue(((U8)"a/b/c").SequenceEqual(p.Topic.Span));
    }
