...
public class TryParseShould
{
    ...
    {
        var actual = Packets.UnsubscribePacket.TryRead(sample, out var packet, out var consumed);
    ...
    {
        var actual = Packets.UnsubscribePacket.TryRead(fragmentedSequence, out var packet, out var consumed);
    ...
    {
        var actual = Packets.UnsubscribePacket.TryRead(largerBufferSample, out var packet, out var consumed);
    ...
    {
        var actual = Packets.UnsubscribePacket.TryRead(largerFragmentedSequence, out var packet, out var consumed);
    ...
    {
        var actual = Packets.UnsubscribePacket.TryRead(incompleteSample, out var packet, out var consumed);
    ...
    {
        var actual = Packets.UnsubscribePacket.TryRead(wrongTypeSample, out var packet, out var consumed);
    ...
    {
        var actual = Packets.UnsubscribePacket.TryRead(Array.Empty<byte>(), out var packet, out var consumed);
