...
{
    [TestClass]
    public class SpanExtensionsEncodeMqttLengthBytesShould
    {
        [TestMethod]
        ...
        public void ThrowIndexOutOfRangeExceptionIfInsufficientBufferSizeProvided()
        {
            ...
            SpanExtensions.WriteMqttLengthBytes(ref actualBytes, 2097151);
        }
        ...
        public void Encode1Byte0GivenValueOf0()
        {
            ...
            var actualCount = SpanExtensions.WriteMqttLengthBytes(ref actualBytes, 0);
        ...
        {
            Span<byte> actualBytes = new byte[4];
            var actualCount = SpanExtensions.WriteMqttLengthBytes(ref actualBytes, 127);
            Assert.AreEqual(1, actualCount);
        ...
        {
            Span<byte> actualBytes = new byte[4];
            var actualCount = SpanExtensions.WriteMqttLengthBytes(ref actualBytes, 128);
        ...
        {
            Span<byte> actualBytes = new byte[4];
            var actualCount = SpanExtensions.WriteMqttLengthBytes(ref actualBytes, 16383);
            Assert.AreEqual(2, actualCount);
        ...
        {
            Span<byte> actualBytes = new byte[4];
            var actualCount = SpanExtensions.WriteMqttLengthBytes(ref actualBytes, 16384);
        ...
        {
            Span<byte> actualBytes = new byte[4];
            var actualCount = SpanExtensions.WriteMqttLengthBytes(ref actualBytes, 2097151);
            Assert.AreEqual(3, actualCount);
            Assert.AreEqual(255, actualBytes[0]);
        ...
        {
            Span<byte> actualBytes = new byte[4];
            var actualCount = SpanExtensions.WriteMqttLengthBytes(ref actualBytes, 2097152);
        ...
        {
            Span<byte> actualBytes = new byte[4];
            var actualCount = SpanExtensions.WriteMqttLengthBytes(ref actualBytes, 268435455);
            Assert.AreEqual(4, actualCount);
            Assert.AreEqual(255, actualBytes[0]);
            Assert.AreEqual(255, actualBytes[1]);
