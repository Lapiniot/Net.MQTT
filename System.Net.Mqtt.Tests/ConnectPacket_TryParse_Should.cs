...
namespace System.Net.Mqtt.Tests
{
    ...
    public class ConnectPacket_TryParse_Should
    {
        ...
        {
            0x06, 0x50, 0x00, 0x04, 0x4d, 0x51, 0x54, 0x54, 0x04, 0xc6, 0x00, 0x78, 0x00, 0x0c, 0x54, 0x65,
        ...
        public ConnectPacket_TryParse_Should()
        {
            ...
            var segment3 = segment2.Append(new byte[]
            {
                0x55, 0x73, 0x65, 0x72, 0x00, 0x0c, 0x54, 0x65, 0x73, 0x74, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f,
                0x72, 0x64
            });

            fragmentedSample = new ReadOnlySequence<byte>(segment1, 0, segment3, 18);
        }
