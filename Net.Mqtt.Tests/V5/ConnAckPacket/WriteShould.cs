namespace Net.Mqtt.Tests.V5.ConnAckPacket;
...
public record class WriteShould
{
    ...
    public void SetHeaderBytes_GivenSampleMessage()
    {
        ...
        var written = new Packets.V5.ConnAckPacket(0x02, true).Write(writer, int.MaxValue);
    ...
    public void EncodeResultBytes_GivenSampleMessage()
    {
        ...
        writer.Clear();
        written = new Packets.V5.ConnAckPacket(0x02, false).Write(writer, int.MaxValue);
    ...
    public void EncodeSessionExpiryInterval_GivenNonDefaultValue()
    {
        ...
        CollectionAssert.AreEqual(new byte[] { 0x20, 0x08, 0x01, 0x02, 0x05, 0x11, 0x00, 0x00, 0x01, 0x2c }, bytes);
    }
    ...
    public void EncodeReceiveMaximum_GivenNonDefaultValue()
    {
        ...
        CollectionAssert.AreEqual(new byte[] { 0x20, 0x06, 0x01, 0x02, 0x03, 0x21, 0x04, 0x00 }, bytes);
    }
    ...
    public void EncodeMaximumQoS_GivenNonDefaultValue()
    {
        ...
        CollectionAssert.AreEqual(new byte[] { 0x20, 0x05, 0x01, 0x02, 0x02, 0x24, 0x01 }, bytes);
    }
    ...
    public void EncodeRetainAvailable_GivenNonDefaultValue()
    {
        ...
        CollectionAssert.AreEqual(new byte[] { 0x20, 0x05, 0x01, 0x02, 0x02, 0x25, 0x00 }, bytes);
    }
    ...
    public void EncodeMaximumPacketSize_GivenNonDefaultValue()
    {
        ...
        CollectionAssert.AreEqual(new byte[] { 0x20, 0x08, 0x01, 0x02, 0x05, 0x27, 0x00, 0x00, 0x10, 0x00 }, bytes);
    }
    ...
    public void EncodeAssignedClientId_GivenNonDefaultValue()
    {
        ...
        CollectionAssert.AreEqual(new byte[] {
            ...
            0x74, 0x78, 0x5f, 0x61, 0x36, 0x34, 0x33, 0x38, 0x63, 0x35, 0x35 }, bytes);
    }
    ...
    public void EncodeTopicAliasMaximum_GivenNonDefaultValue()
    {
        ...
        CollectionAssert.AreEqual(new byte[] { 0x20, 0x06, 0x01, 0x02, 0x03, 0x22, 0x02, 0x00 }, bytes);
    }
    ...
    public void EncodeReasonString_GivenNonDefaultValue()
    {
        ...
        CollectionAssert.AreEqual(new byte[] {
            ...
            0x69, 0x64, 0x20, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x20, 0x69, 0x64 }, bytes);
    }
    ...
    public void OmitReasonString_IfSizeExceedsMaxAllowedBytes()
    {
        ...
        CollectionAssert.AreEqual(new byte[] { 0x20, 0x03, 0x01, 0x02, 0x00 }, bytes);
    }
    ...
    public void EncodeUserProperties_GivenNonDefaultValue()
    {
        ...
        CollectionAssert.AreEqual(new byte[] {
            ...
            0x72, 0x2d, 0x70, 0x72, 0x6f, 0x70, 0x32, 0x2d, 0x76, 0x61, 0x6c, 0x75, 0x65 }, bytes);
    }
    ...
    public void EncodeWildcardSubscriptionAvailable_GivenNonDefaultValue()
    {
        ...
        CollectionAssert.AreEqual(new byte[] { 0x20, 0x05, 0x01, 0x02, 0x02, 0x28, 0x00 }, bytes);
    }
    ...
    public void EncodeSubscriptionIdentifiersAvailable_GivenNonDefaultValue()
    {
        ...
        CollectionAssert.AreEqual(new byte[] { 0x20, 0x05, 0x01, 0x02, 0x02, 0x29, 0x00 }, bytes);
    }
    ...
    public void EncodeSharedSubscriptionAvailable_GivenNonDefaultValue()
    {
        ...
        CollectionAssert.AreEqual(new byte[] { 0x20, 0x05, 0x01, 0x02, 0x02, 0x2a, 0x00 }, bytes);
    }
    ...
    public void EncodeServerKeepAlive_GivenNonDefaultValue()
    {
        ...
        CollectionAssert.AreEqual(new byte[] { 32, 6, 1, 2, 3, 19, 0, 120 }, bytes);
    }
    ...
    public void EncodeResponseInfo_GivenNonDefaultValue()
    {
        ...
        CollectionAssert.AreEqual(new byte[] {
            ...
            0x70, 0x6f, 0x6e, 0x73, 0x65, 0x20, 0x69, 0x6e, 0x66, 0x6f }, bytes);
    }
    ...
    public void EncodeServerReference_GivenNonDefaultValue()
    {
        ...
        CollectionAssert.AreEqual(new byte[] {
            ...
            0x65, 0x72, 0x76, 0x65, 0x72, 0x20, 0x23, 0x31 }, bytes);
    }
    ...
    public void EncodeAuthData_GivenNonDefaultValue()
    {
        ...
        CollectionAssert.AreEqual(new byte[] {
            ...
            0x61, 0x31, 0x61, 0x2d, 0x33, 0x33, 0x37, 0x61, 0x63, 0x37, 0x63, 0x66 }, bytes);
    }
    ...
    public void WriteZeroBytes_IfSizeExceedsMaxAllowedBytes_AndNoPropsToOmit()
    {
        ...
        var connAckPacket = new Packets.V5.ConnAckPacket(0x02, true) { ResponseInfo = "Response info"u8.ToArray() };
        var written = connAckPacket.Write(writer, 16);
