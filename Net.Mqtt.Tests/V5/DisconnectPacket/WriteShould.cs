...
public class WriteShould
{
    ...
    public void EncodeSessionExpiryInterval()
    {
        ...
        CollectionAssert.AreEqual(new byte[] { 0x05, 0x11, 0x00, 0x00, 0x01, 0x2c }, bytes[3..]);
    }
    ...
    public void EncodeReasonString()
    {
        ...
        CollectionAssert.AreEqual(new byte[] {
            ...
            0x64, 0x69, 0x73, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74 }, bytes[3..]);
    }
    ...
    public void OmitReasonString_IfSizeExceedsMaxAllowedBytes()
    {
        ...
        CollectionAssert.AreEqual("\0"u8, bytes[3..]);
    }
    ...
    public void EncodeServerReference()
    {
        ...
        CollectionAssert.AreEqual(new byte[] {
            ...
            0x65, 0x72, 0x2d, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72 }, bytes[3..]);
    }
    ...
    public void EncodeUserProperties()
    {
        ...
        CollectionAssert.AreEqual(new byte[] {
            ...
            0x72, 0x6f, 0x70, 0x32, 0x2d, 0x76, 0x61, 0x6c, 0x75, 0x65 }, bytes[3..]);
    }
