...
public class TryReadPropertiesSequenceShould
{
    ...
    public void ReturnTrue_Properties_GivenValidSample()
    {
        ...
        var actual = TryReadProperties(sequence, out var sessionExpiryInterval, out var reasonString,
    ...
    public void ReturnFalse_GivenUnknownPropertyIdentifier()
    {
        ...
        var actual = TryReadProperties(sequence, out var sessionExpiryInterval,
    ...
    public void ReturnTrue_EmptyProperties_GivenNoUserProperties()
    {
        ...
        var actual = TryReadProperties(ReadOnlySequence<byte>.Empty, out var sessionExpiryInterval,
            out var reasonString, out var serverReference, out var properties);
