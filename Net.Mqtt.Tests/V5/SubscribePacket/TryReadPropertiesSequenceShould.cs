using static Net.Mqtt.Packets.V5.SubscribePacket;
...
{
    [TestMethod]
    public void ReturnTrue_Properties_GivenValidSample()
    {
        ...
        var actual = TryReadProperties(sequence, out var subscriptionId, out var properties);

        Assert.IsTrue(actual);
        Assert.AreEqual(2u, subscriptionId);
    ...
    {
        var actual = TryReadProperties(ReadOnlySequence<byte>.Empty, out var subscriptionId, out var properties);
