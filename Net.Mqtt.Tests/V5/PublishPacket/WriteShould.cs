...
public class WriteShould
{
    ...
    public void EncodePayload_GivenSampleMessage()
    {
        ...
        CollectionAssert.AreEqual("TestMessage"u8, actualMessage);
    }
    ...
    public void EncodePayloadFormat_GivenMessageWithNotDefaultValue()
    {
        ...
        CollectionAssert.AreEqual((byte[])[0x02, 0x01, 0x01], bytes[9..]);
    }
    ...
    public void EncodeMessageExpiryInterval_GivenMessageWithNotDefaultValue()
    {
        ...
        CollectionAssert.AreEqual((byte[])[0x05, 0x02, 0x00, 0x00, 0x01, 0x2c], bytes[9..]);
    }
    ...
    public void EncodeContentType_GivenMessageWithNotDefaultValue()
    {
        ...
        CollectionAssert.AreEqual((byte[])[0x0d, 0x03, 0x00, 0x0a, 0x74, 0x65, 0x78, 0x74, 0x2f, 0x70, 0x6c, 0x61, 0x69, 0x6e], bytes[9..]);
    }
    ...
    public void EncodeResponseTopic_GivenMessageWithNotDefaultValue()
    {
        ...
        CollectionAssert.AreEqual((byte[])[0x0d, 0x08, 0x00, 0x0a, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2f, 0x31], bytes[9..]);
    }
    ...
    public void EncodeCorrelationData_GivenMessageWithNotDefaultValue()
    {
        ...
        CollectionAssert.AreEqual((byte[])[0x0d, 0x09, 0x00, 0x0a, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39], bytes[9..]);
    }
    ...
    public void EncodeSubscriptionId_GivenMessageWithNotDefaultValue()
    {
        ...
        CollectionAssert.AreEqual((byte[])[0x09, 0x0b, 0xa8, 0x96, 0x10, 0x0b, 0x80, 0x08, 0x0b, 0x2a], bytes[9..]);
    }
    ...
    public void EncodeTopicAlias_GivenMessageWithNotDefaultValue()
    {
        ...
        CollectionAssert.AreEqual((byte[])[0x03, 0x23, 0x75, 0x30], bytes[9..]);
    }
    ...
    public void EncodeProperties_GivenMessageWithNotDefaultValue()
    {
        ...
        CollectionAssert.AreEqual((byte[])[0x30, 0x48, 0x00, 0x05, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x40, 0x26, 0x00, 0x0b, 0x75, 0x73, 0x65, 0x72, 0x2d, 0x70, 0x72, 0x6f, 0x70, 0x2d, 0x31, 0x00, 0x10, 0x75, 0x73, 0x65, 0x72, 0x2d, 0x70, 0x72, 0x6f, 0x70, 0x31, 0x2d, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x26, 0x00, 0x0b, 0x75, 0x73, 0x65, 0x72, 0x2d, 0x70, 0x72, 0x6f, 0x70, 0x2d, 0x32, 0x00, 0x10, 0x75, 0x73, 0x65, 0x72, 0x2d, 0x70, 0x72, 0x6f, 0x70, 0x32, 0x2d, 0x76, 0x61, 0x6c, 0x75, 0x65], bytes);
    }
