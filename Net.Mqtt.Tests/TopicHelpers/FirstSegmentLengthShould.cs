...
public class FirstSegmentLengthShould
{
    ...
    public void ReturnFirstDelimiterPositionGivenSource_HitsUnrolledLoop()
    {
        ...
        var actual = FirstSegmentLength(ref Unsafe.AsRef(in source[0]), (nuint)source.Length);
        Assert.AreEqual(12u, actual);

        source = "aaaabbbbccc/"u8;
        actual = FirstSegmentLength(ref Unsafe.AsRef(in source[0]), (nuint)source.Length);
