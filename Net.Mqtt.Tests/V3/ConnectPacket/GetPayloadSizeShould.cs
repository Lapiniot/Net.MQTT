...
public class GetPayloadSizeShould
{
    ...
    {
        var m = new Packets.V3.ConnectPacket(ReadOnlyMemory<byte>.Empty, 0x04, "MQTT"u8.ToArray());
    ...
    {
        var m = new Packets.V3.ConnectPacket("test-client-id"u8.ToArray(), 0x04, "MQTT"u8.ToArray(), willTopic: "last/will/abc"u8.ToArray(), willMessage: "last-will-packet"u8.ToArray());
