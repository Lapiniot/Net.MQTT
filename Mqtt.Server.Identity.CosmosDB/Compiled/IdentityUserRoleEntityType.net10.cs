    ...
    public partial class IdentityUserRoleEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            __jObject.SetAccessors(
                JObject (IInternalEntry entry) => (entry.FlaggedAsStoreGenerated(2) ? entry.ReadStoreGeneratedValue<JObject>(2) : (entry.FlaggedAsTemporary(2) && entry.ReadShadowValue<JObject>(0) == null ? entry.ReadTemporaryValue<JObject>(2) : entry.ReadShadowValue<JObject>(0))),
        ...
        public static void CreateAnnotations(RuntimeEntityType runtimeEntityType)
        {
            ...
            runtimeEntityType.SetTemporaryValuesFactory(
                ISnapshot (IInternalEntry source) => ((ISnapshot)(new Snapshot<string, string, JObject>(default(string), default(string), default(JObject)))));
