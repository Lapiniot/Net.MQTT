...
namespace Mqtt.Server.Identity.CosmosDB.Compiled
{
    ...
    public partial class IdentityPasskeyDataEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            identityUserPasskeyCredentialId.TypeMapping = CosmosTypeMapping.Default.Clone(
            ...
            attestationObject.TypeMapping = CosmosTypeMapping.Default.Clone(
                comparer: new ValueComparer<byte[]>(
                    bool (byte[] v1, byte[] v2) => StructuralComparisons.StructuralEqualityComparer.Equals(((object)(v1)), ((object)(v2))),
                    int (byte[] v) => ((object)v).GetHashCode(),
                    byte[] (byte[] v) => v),
            ...
            clientDataJson.SetPropertyIndexes(
                ...
                relationshipIndex: -1,
                storeGenerationIndex: -1);
            clientDataJson.TypeMapping = CosmosTypeMapping.Default.Clone(
                comparer: new ValueComparer<byte[]>(
                    bool (byte[] v1, byte[] v2) => StructuralComparisons.StructuralEqualityComparer.Equals(((object)(v1)), ((object)(v2))),
                    int (byte[] v) => ((object)v).GetHashCode(),
                    byte[] (byte[] v) => v),
            ...
            createdAt.SetPropertyIndexes(
                ...
                relationshipIndex: -1,
                storeGenerationIndex: -1);
            createdAt.TypeMapping = CosmosTypeMapping.Default.Clone(
            ...
            isBackedUp.SetPropertyIndexes(
                ...
                relationshipIndex: -1,
                storeGenerationIndex: -1);
            isBackedUp.TypeMapping = CosmosTypeMapping.Default.Clone(
            ...
            isBackupEligible.SetPropertyIndexes(
                ...
                relationshipIndex: -1,
                storeGenerationIndex: -1);
            isBackupEligible.TypeMapping = CosmosTypeMapping.Default.Clone(
                comparer: new ValueComparer<bool>(
                    bool (bool v1, bool v2) => v1 == v2,
                    int (bool v) => ((object)v).GetHashCode(),
                    bool (bool v) => v),
            ...
            isUserVerified.SetPropertyIndexes(
                ...
                relationshipIndex: -1,
                storeGenerationIndex: -1);
            isUserVerified.TypeMapping = CosmosTypeMapping.Default.Clone(
                comparer: new ValueComparer<bool>(
                    bool (bool v1, bool v2) => v1 == v2,
                    int (bool v) => ((object)v).GetHashCode(),
                    bool (bool v) => v),
            ...
            publicKey.SetPropertyIndexes(
                ...
                relationshipIndex: -1,
                storeGenerationIndex: -1);
            publicKey.TypeMapping = CosmosTypeMapping.Default.Clone(
                comparer: new ValueComparer<byte[]>(
                    bool (byte[] v1, byte[] v2) => StructuralComparisons.StructuralEqualityComparer.Equals(((object)(v1)), ((object)(v2))),
                    int (byte[] v) => ((object)v).GetHashCode(),
                    byte[] (byte[] v) => v),
            ...
            signCount.SetPropertyIndexes(
                ...
                relationshipIndex: -1,
                storeGenerationIndex: -1);
            signCount.TypeMapping = CosmosTypeMapping.Default.Clone(
            ...
            transports.SetPropertyIndexes(
                ...
                relationshipIndex: -1,
                storeGenerationIndex: -1);
            transports.TypeMapping = CosmosTypeMapping.Default.Clone(
            ...
            __jObject.SetAccessors(
                JObject (IInternalEntry entry) => (entry.FlaggedAsStoreGenerated(11) ? entry.ReadStoreGeneratedValue<JObject>(1) : (entry.FlaggedAsTemporary(11) && entry.ReadShadowValue<JObject>(1) == null ? entry.ReadTemporaryValue<JObject>(1) : entry.ReadShadowValue<JObject>(1))),
