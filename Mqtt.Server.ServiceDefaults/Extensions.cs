...
public static class ServiceExtensions
{
    ...
    extension<TBuilder>(TBuilder builder) where TBuilder : IHostApplicationBuilder
    {
        ...
        public TBuilder ConfigureOpenTelemetry()
        {
            ...
            var otb = builder.Services.AddOpenTelemetry()
        ...
        {
            builder.Services.AddOutputCache(options => options.AddPolicy("HealthChecks", pb => pb.Expire(TimeSpan.FromSeconds(10))));

            builder.Services.AddRequestTimeouts(options => options.AddPolicy("HealthChecks", TimeSpan.FromSeconds(2)));
