...
namespace Mqtt.Server.Identity.SqlServer.Compiled
{
    public partial class ApplicationDbContextModel
    {
        private ApplicationDbContextModel()
            : base(skipDetectChanges: false, modelId: new Guid("bee3babb-8de7-4481-b275-7e5eb9d38e12"), entityTypeCount: 9)
        {
        }
        ...
        private IRelationalModel CreateRelationalModel()
        {
            ...
            var identityPasskeyData = FindEntityType("Microsoft.AspNetCore.Identity.IdentityPasskeyData")!;

            var defaultTableMappings = new List<TableMappingBase<ColumnMappingBase>>();
            identityPasskeyData.SetRuntimeAnnotation("Relational:DefaultMappings", defaultTableMappings);
            var microsoftAspNetCoreIdentityIdentityUserPasskeystringTableBase = new TableBase("Microsoft.AspNetCore.Identity.IdentityUserPasskey<string>", null, relationalModel);
            var credentialIdColumnBase = new ColumnBase<ColumnMappingBase>("CredentialId", "varbinary(1024)", microsoftAspNetCoreIdentityIdentityUserPasskeystringTableBase);
            microsoftAspNetCoreIdentityIdentityUserPasskeystringTableBase.Columns.Add("CredentialId", credentialIdColumnBase);
            var dataColumnBase = new JsonColumnBase("Data", "nvarchar(max)", microsoftAspNetCoreIdentityIdentityUserPasskeystringTableBase);
            microsoftAspNetCoreIdentityIdentityUserPasskeystringTableBase.Columns.Add("Data", dataColumnBase);
            var userIdColumnBase = new ColumnBase<ColumnMappingBase>("UserId", "nvarchar(450)", microsoftAspNetCoreIdentityIdentityUserPasskeystringTableBase);
            microsoftAspNetCoreIdentityIdentityUserPasskeystringTableBase.Columns.Add("UserId", userIdColumnBase);
            relationalModel.DefaultTables.Add("Microsoft.AspNetCore.Identity.IdentityUserPasskey<string>", microsoftAspNetCoreIdentityIdentityUserPasskeystringTableBase);
            var microsoftAspNetCoreIdentityIdentityUserPasskeystringMappingBase = new TableMappingBase<ColumnMappingBase>(identityPasskeyData, microsoftAspNetCoreIdentityIdentityUserPasskeystringTableBase, null);
            microsoftAspNetCoreIdentityIdentityUserPasskeystringTableBase.AddTypeMapping(microsoftAspNetCoreIdentityIdentityUserPasskeystringMappingBase, null);
            defaultTableMappings.Add(microsoftAspNetCoreIdentityIdentityUserPasskeystringMappingBase);

            var tableMappings = new List<TableMapping>();
            identityPasskeyData.SetRuntimeAnnotation("Relational:TableMappings", tableMappings);

            var identityUserPasskey = FindEntityType("Microsoft.AspNetCore.Identity.IdentityUserPasskey<string>")!;

            var defaultTableMappings4 = new List<TableMappingBase<ColumnMappingBase>>();
            identityUserPasskey.SetRuntimeAnnotation("Relational:DefaultMappings", defaultTableMappings4);
            var microsoftAspNetCoreIdentityIdentityUserPasskeystringMappingBase0 = new TableMappingBase<ColumnMappingBase>(identityUserPasskey, microsoftAspNetCoreIdentityIdentityUserPasskeystringTableBase, null);
            microsoftAspNetCoreIdentityIdentityUserPasskeystringTableBase.AddTypeMapping(microsoftAspNetCoreIdentityIdentityUserPasskeystringMappingBase0, false);
            defaultTableMappings4.Add(microsoftAspNetCoreIdentityIdentityUserPasskeystringMappingBase0);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)credentialIdColumnBase, identityUserPasskey.FindProperty("CredentialId")!, microsoftAspNetCoreIdentityIdentityUserPasskeystringMappingBase0);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)userIdColumnBase, identityUserPasskey.FindProperty("UserId")!, microsoftAspNetCoreIdentityIdentityUserPasskeystringMappingBase0);

            var aspNetUserPasskeysTable = new Table("AspNetUserPasskeys", null, relationalModel);
            var credentialIdColumn = new Column("CredentialId", "varbinary(1024)", aspNetUserPasskeysTable);
            aspNetUserPasskeysTable.Columns.Add("CredentialId", credentialIdColumn);
            credentialIdColumn.Accessors = ColumnAccessorsFactory.CreateGeneric<byte[]>(credentialIdColumn);
            var dataColumn = new JsonColumn("Data", "nvarchar(max)", aspNetUserPasskeysTable);
            aspNetUserPasskeysTable.Columns.Add("Data", dataColumn);
            dataColumn.Accessors = ColumnAccessorsFactory.CreateGeneric<JsonTypePlaceholder>(dataColumn);
            var userIdColumn = new Column("UserId", "nvarchar(450)", aspNetUserPasskeysTable);
            aspNetUserPasskeysTable.Columns.Add("UserId", userIdColumn);
            userIdColumn.Accessors = ColumnAccessorsFactory.CreateGeneric<string>(userIdColumn);
            relationalModel.Tables.Add(("AspNetUserPasskeys", null), aspNetUserPasskeysTable);
            var aspNetUserPasskeysTableMapping = new TableMapping(identityPasskeyData, aspNetUserPasskeysTable, null)
            {
                IsSharedTablePrincipal = false,
            };
            aspNetUserPasskeysTable.AddTypeMapping(aspNetUserPasskeysTableMapping, null);
            tableMappings.Add(aspNetUserPasskeysTableMapping);
            aspNetUserPasskeysTable.AddRowInternalForeignKey(identityPasskeyData, RelationalModel.GetForeignKey(this,
            ...
            identityUserPasskey.SetRuntimeAnnotation("Relational:TableMappings", tableMappings4);
            var aspNetUserPasskeysTableMapping0 = new TableMapping(identityUserPasskey, aspNetUserPasskeysTable, null)
            {
                IsSharedTablePrincipal = true,
            };
            aspNetUserPasskeysTable.AddTypeMapping(aspNetUserPasskeysTableMapping0, false);
            tableMappings4.Add(aspNetUserPasskeysTableMapping0);
            RelationalModel.CreateColumnMapping(credentialIdColumn, identityUserPasskey.FindProperty("CredentialId")!, aspNetUserPasskeysTableMapping0);
            RelationalModel.CreateColumnMapping(userIdColumn, identityUserPasskey.FindProperty("UserId")!, aspNetUserPasskeysTableMapping0);
            var pK_AspNetUserPasskeys = new UniqueConstraint("PK_AspNetUserPasskeys", aspNetUserPasskeysTable, new[] { credentialIdColumn });
            aspNetUserPasskeysTable.PrimaryKey = pK_AspNetUserPasskeys;
            pK_AspNetUserPasskeys.SetRowKeyValueFactory(new SimpleRowKeyValueFactory<byte[]>(pK_AspNetUserPasskeys));
            var pK_AspNetUserPasskeysKey = RelationalModel.GetKey(this,
                "Microsoft.AspNetCore.Identity.IdentityUserPasskey<string>",
                new[] { "CredentialId" });
            pK_AspNetUserPasskeys.MappedKeys.Add(pK_AspNetUserPasskeysKey);
            RelationalModel.GetOrCreateUniqueConstraints(pK_AspNetUserPasskeysKey).Add(pK_AspNetUserPasskeys);
            aspNetUserPasskeysTable.UniqueConstraints.Add("PK_AspNetUserPasskeys", pK_AspNetUserPasskeys);
            var iX_AspNetUserPasskeys_UserId = new TableIndex(
            "IX_AspNetUserPasskeys_UserId", aspNetUserPasskeysTable, new[] { userIdColumn }, false);
            iX_AspNetUserPasskeys_UserId.SetRowIndexValueFactory(new SimpleRowIndexValueFactory<string>(iX_AspNetUserPasskeys_UserId));
            var iX_AspNetUserPasskeys_UserIdIx = RelationalModel.GetIndex(this,
                "Microsoft.AspNetCore.Identity.IdentityUserPasskey<string>",
                new[] { "UserId" });
            iX_AspNetUserPasskeys_UserId.MappedIndexes.Add(iX_AspNetUserPasskeys_UserIdIx);
            RelationalModel.GetOrCreateTableIndexes(iX_AspNetUserPasskeys_UserIdIx).Add(iX_AspNetUserPasskeys_UserId);
            aspNetUserPasskeysTable.Indexes.Add("IX_AspNetUserPasskeys_UserId", iX_AspNetUserPasskeys_UserId);
            ...
            var userIdColumnBase0 = new ColumnBase<ColumnMappingBase>("UserId", "nvarchar(450)", microsoftAspNetCoreIdentityIdentityUserClaimstringTableBase);
            ...
            var userIdColumn0 = new Column("UserId", "nvarchar(450)", aspNetUserClaimsTable);
            ...
            var loginProviderColumnBase = new ColumnBase<ColumnMappingBase>("LoginProvider", "nvarchar(128)", microsoftAspNetCoreIdentityIdentityUserLoginstringTableBase);
            ...
            var providerKeyColumnBase = new ColumnBase<ColumnMappingBase>("ProviderKey", "nvarchar(128)", microsoftAspNetCoreIdentityIdentityUserLoginstringTableBase);
            microsoftAspNetCoreIdentityIdentityUserLoginstringTableBase.Columns.Add("ProviderKey", providerKeyColumnBase);
            var userIdColumnBase1 = new ColumnBase<ColumnMappingBase>("UserId", "nvarchar(450)", microsoftAspNetCoreIdentityIdentityUserLoginstringTableBase);
            ...
            var loginProviderColumn = new Column("LoginProvider", "nvarchar(128)", aspNetUserLoginsTable);
            ...
            var providerKeyColumn = new Column("ProviderKey", "nvarchar(128)", aspNetUserLoginsTable);
            ...
            var userIdColumn1 = new Column("UserId", "nvarchar(450)", aspNetUserLoginsTable);
            ...
            var userIdColumnBase2 = new ColumnBase<ColumnMappingBase>("UserId", "nvarchar(450)", microsoftAspNetCoreIdentityIdentityUserRolestringTableBase);
            ...
            var userIdColumn2 = new Column("UserId", "nvarchar(450)", aspNetUserRolesTable);
            ...
            var loginProviderColumnBase0 = new ColumnBase<ColumnMappingBase>("LoginProvider", "nvarchar(128)", microsoftAspNetCoreIdentityIdentityUserTokenstringTableBase);
            microsoftAspNetCoreIdentityIdentityUserTokenstringTableBase.Columns.Add("LoginProvider", loginProviderColumnBase0);
            var nameColumnBase0 = new ColumnBase<ColumnMappingBase>("Name", "nvarchar(128)", microsoftAspNetCoreIdentityIdentityUserTokenstringTableBase);
            microsoftAspNetCoreIdentityIdentityUserTokenstringTableBase.Columns.Add("Name", nameColumnBase0);
            var userIdColumnBase3 = new ColumnBase<ColumnMappingBase>("UserId", "nvarchar(450)", microsoftAspNetCoreIdentityIdentityUserTokenstringTableBase);
            ...
            var userIdColumn3 = new Column("UserId", "nvarchar(450)", aspNetUserTokensTable);
            ...
            var loginProviderColumn0 = new Column("LoginProvider", "nvarchar(128)", aspNetUserTokensTable);
            ...
            var nameColumn0 = new Column("Name", "nvarchar(128)", aspNetUserTokensTable);
            ...
            applicationUser.SetRuntimeAnnotation("Relational:DefaultMappings", defaultTableMappings7);
            ...
            var phoneNumberColumnBase = new ColumnBase<ColumnMappingBase>("PhoneNumber", "nvarchar(256)", mqttServerIdentityDataApplicationUserTableBase)
            {
                IsNullable = true
            };
            ...
            defaultTableMappings7.Add(mqttServerIdentityDataApplicationUserMappingBase);
            ...
            applicationUser.SetRuntimeAnnotation("Relational:TableMappings", tableMappings7);
            ...
            var phoneNumberColumn = new Column("PhoneNumber", "nvarchar(256)", aspNetUsersTable)
            {
                IsNullable = true
            };
            ...
            var fK_AspNetUserPasskeys_AspNetUsers_UserId = new ForeignKeyConstraint(
                "FK_AspNetUserPasskeys_AspNetUsers_UserId", aspNetUserPasskeysTable, aspNetUsersTable,
                new[] { userIdColumn },
                aspNetUsersTable.FindUniqueConstraint("PK_AspNetUsers")!, ReferentialAction.Cascade);
            fK_AspNetUserPasskeys_AspNetUsers_UserId.SetRowForeignKeyValueFactory(RowForeignKeyValueFactoryFactory.CreateSimpleNullableFactory<string, string>(fK_AspNetUserPasskeys_AspNetUsers_UserId));
            var fK_AspNetUserPasskeys_AspNetUsers_UserIdFk = RelationalModel.GetForeignKey(this,
                "Microsoft.AspNetCore.Identity.IdentityUserPasskey<string>",
                new[] { "UserId" },
                "Mqtt.Server.Identity.Data.ApplicationUser",
                new[] { "Id" });
            fK_AspNetUserPasskeys_AspNetUsers_UserId.MappedForeignKeys.Add(fK_AspNetUserPasskeys_AspNetUsers_UserIdFk);
            RelationalModel.GetOrCreateForeignKeyConstraints(fK_AspNetUserPasskeys_AspNetUsers_UserIdFk).Add(fK_AspNetUserPasskeys_AspNetUsers_UserId);
            aspNetUserPasskeysTable.ForeignKeyConstraints.Add(fK_AspNetUserPasskeys_AspNetUsers_UserId);
            aspNetUsersTable.ReferencingForeignKeyConstraints.Add(fK_AspNetUserPasskeys_AspNetUsers_UserId);
